...
const NotFoundPage = () => {
    ...
    return (
        <div className="surface-ground flex align-items-center justify-content-center min-h-screen min-w-screen overflow-hidden relative">
            <div className="flex flex-column align-items-center justify-content-center">
                ...
                >
                    <div className="w-full surface-card py-8 px-5 sm:px-8 flex flex-column align-items-center" style={{ borderRadius: '53px' }}>
                        ...
                        <div className="text-600 mb-5">{t('description')}</div>
                        ...
                        <Link href="/" className="w-full flex align-items-center py-5 border-300 border-bottom-1">
                            ...
                            <span className="ml-4 flex flex-column">
                                <span className="text-900 lg:text-xl font-medium mb-1">{t('faqTitle')}</span>
                                <span className="text-600 lg:text-lg">{t('faqSubtitle')}</span>
                            </span>
                        </Link>
                        ...
                        <Link href="/" className="w-full flex align-items-center py-5 border-300 border-bottom-1">
                            ...
                            <span className="ml-4 flex flex-column">
                                <span className="text-900 lg:text-xl font-medium mb-1">{t('solutionTitle')}</span>
                                <span className="text-600 lg:text-lg">{t('solutionSubtitle')}</span>
                            </span>
                        </Link>
                        ...
                        <Link href="/" className="w-full flex align-items-center mb-5 py-5 border-300 border-bottom-1">
                            ...
                            <span className="ml-4 flex flex-column">
                                <span className="text-900 lg:text-xl font-medium mb-1">{t('permissionsTitle')}</span>
                                <span className="text-600 lg:text-lg">{t('permissionsSubtitle')}</span>
                            </span>
                        </Link>
