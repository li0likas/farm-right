    ...
    <div>
      <div className="container bg-white pt-12">
        ...
        <div className="text-center mb-4">
          <button
            className={`px-4 py-2 rounded-lg mx-2 ${activeTab === "upcoming" ? "bg-[#61E9B1] text-black" : "bg-gray-300 text-gray-800"}`}
            onClick={() => setActiveTab("upcoming")}
          >
            Upcoming Tasks
          </button>
          <button
            className={`px-4 py-2 rounded-lg mx-2 ${activeTab === "completed" ? "bg-[#61E9B1] text-black" : "bg-gray-300 text-gray-800"}`}
        ...
        <div className="md:flex">
          <div className="w-full grid md:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-4 pl-5 pr-5">
            {filteredTasks.map((task) => (
              <div key={task.id} className="h-[385px] rounded-xl mt-3 text-center pt-5 pb-5 bg-gray-50 border border-solid border-[#61E9B1]">
                ...
                <div>
                  <div className="max-w-64">
                    ...
                    <p className="text-sm"><i className="fa-solid fa-money-check-dollar"></i> Status: {task.status}</p>
                  </div>
                ...
                <div className="flex">
                  <Link to="/task-details" className="mx-auto bg-[#61E9B1] hover:bg-[#4edba1] rounded-lg text-black p-3 md:my-6 text-sm">
                    View Task
                  </Link>
                </div>
              </div>
